...
variable "gcp_location" {
  description = "The location (zone or region) this cluster has been created in. (region: us-east1, zone: us-east1-a)"
}
...
variable "min_node_count_builds" {
  description = "Min Number of worker VMs to create"
  default = 3
}

variable "max_node_count_builds" {
  description = "Max Number of worker VMs to create"
  default = 5
}

variable "node_machine_type_builds" {
  description = "GCE machine type"
